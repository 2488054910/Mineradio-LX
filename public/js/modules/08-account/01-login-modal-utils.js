...
function bindModalBackdropClose() {
  [
    ...
    ['custom-source-modal', closeCustomSourceModal]
...
function platformMeta(provider) {
  ...
  if (provider === 'lxmusic') return { key: 'lxmusic', short: '免费', label: '免费音源', app: 'lx-music 音源' };
  return { key: 'netease', short: 'NE', label: '网易云音乐', app: '网易云音乐 App', dot: 'netease' };
}
function platformStatus(provider) {
  if (provider === 'lxmusic' && typeof lxmusicLoginStatus !== 'undefined') return lxmusicLoginStatus;
